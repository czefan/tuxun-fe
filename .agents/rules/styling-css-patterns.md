---
trigger: glob
description: SCSS, UnoCSS and atomic CSS styling guidelines
globs: src/**/*.vue, src/**/*.scss, src/**/*.css
---
...
- 配置在 [uno.config.ts](file:///home/chai_/Club/tuxun/tuxun-fe/uno.config.ts)
- 支持预设和自定义规则
- 优先使用原子化类名，减少自定义 CSS
