---
trigger: glob
description: Lifecycle, routing definePage, conditional compiles in uni-app pages and components
...
- 页面文件放在 [src/pages/](file:///home/chai_/Club/tuxun/tuxun-fe/src/pages) 目录下
- 使用约定式路由，文件名即路由路径
...
- 组件文件放在 [src/components/](file:///home/chai_/Club/tuxun/tuxun-fe/src/components) 或者 [src/pages/xx/components/](file:///home/chai_/Club/tuxun/tuxun-fe/src/pages) 目录下
